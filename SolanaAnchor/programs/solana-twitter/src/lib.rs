...
// use anchor_lang::prelude::ProgramError as From<PubkeyError>
// use anchor_lang::prelude::ProgramError as From<PubkeyError>;



declare_id!("2FMfGHc7zqgKS8oDTVZPNvUGz5KAPb8G9mbQX8vgcf2C");
...
pub mod memelife {
    ...
    // changed ProgramResult to Result<()>
    ...
    pub fn withdraw(ctx: Context<Withdraw>, amount: u64) -> Result<()> {
        ...
        if amount > lamports {
            ...
            // return err!(Errors::NotEnoughPoolAmount.into());
        }
